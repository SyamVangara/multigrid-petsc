...
void CreateSolver(Indices *indices, Solver *solver) {
...
void Assemble(Problem *prob, Grids *grids, Indices *indices, Operator *op, Solver *solver) {
...
//		
//		Res_delayed(indices, op, &bottomLevel, &topLevel, assem);
