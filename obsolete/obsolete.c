...
//	// Assembles the restriction matrices for delayed cycling
//	// Restriction is from all fine grids to all coarse grids
//	
//	int	levels=1;
//	
////	levels = assem->levels;
...
////	}
//
//	if (indices->level[0].grids<2) {
//		PetscPrintf(PETSC_COMM_WORLD, "Restriction matrix for delayed cycling requires more than 2 grids in the given level\n");
//		return;
//	}
//	
